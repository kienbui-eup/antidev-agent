...
Xin chào, tôi là [Kien Bui](https://github.com/KienBui-eup). Tôi là một developer đam mê xây dựng phần mềm và khám phá những giới hạn của AI trong lập trình. Tôi đã xây dựng nhiều sản phẩm với tư cách là developer và luôn tìm kiếm cách tốt hơn để ship code chất lượng nhanh hơn.
...
Mười lăm chuyên gia và sáu công cụ mạnh mẽ. Tất cả là slash command. Tất cả là Markdown. Tất cả miễn phí. **[github.com/KienBui-eup/gstack](https://github.com/KienBui-eup/gstack)** — MIT License

> **Đóng góp cho gstack.** Muốn cải thiện công cụ này? Fork và gửi PR tại [github.com/KienBui-eup/gstack](https://github.com/KienBui-eup/gstack).
