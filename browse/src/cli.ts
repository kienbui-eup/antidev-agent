/**
 * antidev CLI — thin wrapper that talks to the persistent server
 *
 * Flow:
 *   1. Read .antidev/browse.json for port + token
...
async function main() {
  ...
  if (args.length === 0 || args[0] === '--help' || args[0] === '-h') {
    console.log(`antidev browse — Fast headless browser for AI coding agents
