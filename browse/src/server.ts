/**
 * antidev browse server — persistent Chromium daemon
 *
 * Architecture:
 ...
 *
 * State:
 *   State file: <project-root>/.antidev/browse.json (set via BROWSE_STATE_FILE env)
 *   Log files:  <project-root>/.antidev/browse-{console,network,dialog}.log
...
function generateHelpText(): string {
  ...
  const lines = ['antidev browse — headless browser for AI agents', '', 'Commands:'];
