...
export const E2E_TOUCHFILES: Record<string, string[]> = {
  ...
  'ship-jira-ticket-extraction': ['ship/**', 'jira/**', 'scripts/jira.ts'],
  'ship-jira-missing-env': ['ship/**', 'jira/**', 'scripts/jira.ts'],
  'ship-jira-transition-failure': ['ship/**', 'jira/**', 'scripts/jira.ts'],
...
export const LLM_JUDGE_TOUCHFILES: Record<string, string[]> = {
  ...
  'antidev-upgrade/SKILL.md upgrade flow': ['antidev-upgrade/SKILL.md', 'antidev-upgrade/SKILL.md.tmpl'],
};
